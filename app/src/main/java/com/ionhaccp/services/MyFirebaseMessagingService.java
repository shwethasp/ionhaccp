...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        /*
        * Push Notification Enable Or disable
        * */
        SharedPreferences preferences = getSharedPreferences(Config.SHARED_PREF, MODE_PRIVATE);
        boolean isNotificationEnable = preferences.getBoolean(Config.isNotificationEnable, true);
    ...
    private void sendNotification(String messageBody) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.mipmap.ion_ic_launcher)
                .setContentTitle("Ionhaccp")
